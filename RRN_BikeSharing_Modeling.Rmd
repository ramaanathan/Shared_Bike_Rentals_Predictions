---
title: "FinalProject_s"
author: "Ramaa Nathan"
date: "8/4/2018"
output: html_document
---

Version b: This version contains the 24 data sets and the modeling of the gam models for all the 24 datasets
Version c: This version removes season, cleans up the dataset - factors all the categorical variables and uses stratified partitioning within each dataset; random forests and boosting implemented
Version d: Added the second test dataset that also has the counts
Version e: Added analysis for each model
version f: partitioned the test data sets too
